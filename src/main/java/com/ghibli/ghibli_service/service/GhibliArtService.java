package com.ghibli.ghibli_service.service;

import com.ghibli.ghibli_service.client.StabilityAIClient;
import com.ghibli.ghibli_service.dto.request.TextToImageRequestDTO;
...
public class GhibliArtService {
    ...
    public byte[] createGhibliArtFromText(String prompt, String style) {
        ...
        TextToImageRequestDTO requestPayload = new TextToImageRequestDTO(finalPrompt, stylePreset);
